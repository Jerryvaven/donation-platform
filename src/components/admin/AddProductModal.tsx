          ...
          >
            ...
            <div className="flex justify-between items-center mb-8">
              <div className="flex items-center gap-4">
                <motion.div
                  className={`p-3 ${darkMode ? 'bg-[#3B82F6]' : 'bg-black'} rounded-xl`}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className={`w-full px-4 py-2.5 ${darkMode ? 'bg-[#242424] border-[#333333] text-white' : 'bg-white border-gray-300 text-gray-900'} border rounded-lg focus:ring-2 ${darkMode ? 'focus:ring-[#3B82F6] focus:border-[#3B82F6]' : 'focus:ring-black focus:border-black'} transition-all`}
                  placeholder="e.g., King Sauna"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className={`w-full px-4 py-2.5 ${darkMode ? 'bg-[#242424] border-[#333333] text-white' : 'bg-white border-gray-300 text-gray-900'} border rounded-lg focus:ring-2 ${darkMode ? 'focus:ring-[#3B82F6] focus:border-[#3B82F6]' : 'focus:ring-black focus:border-black'} transition-all resize-none`}
              ...
              <div>
                ...
                {uploadMethod === 'url' ? (
                  ...
                  <div>
                    ...
                    <label
                      htmlFor="imageUpload"
                      className={`block w-full p-6 border-2 border-dashed rounded-lg cursor-pointer transition-all duration-200 hover:shadow-md ${darkMode ? 'border-[#333333] hover:border-[#3B82F6] hover:bg-[#242424]' : 'border-gray-300 hover:border-gray-400 hover:bg-gray-50'}`}
                    >
                      {imagePreview ? (
              ...
              <div className="flex gap-4 pt-6 mt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className={`flex-1 py-3 px-6 rounded-lg font-semibold transition-all duration-200 ${darkMode ? 'bg-[#3B82F6] text-white hover:bg-[#2563EB]' : 'bg-black text-white hover:bg-gray-800'} disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2`}
                >
                  {addingProduct ? (
                    <>
