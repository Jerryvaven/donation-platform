  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json(
        { error: 'Failed to update fire department', details: error.message },
        { status: 500 }
      )
    }
    ...
    if (!data) {
      return NextResponse.json(
        { error: 'Fire department not found' },
        { status: 404 }
      )
    }
...
export async function DELETE(
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json(
        { error: 'Failed to delete fire department', details: error.message },
        { status: 500 }
      )
    }
