...
export async function POST(request: NextRequest) {
  try {
    ...
    const { donorName, city, county, address, productId, quantity, matched, fireDepartmentId } = body
    ...
    const productValue = product ? parseFloat(product.value.toString()) * parseInt(quantity) : 0
