...
import ColdPlungeProduct from '@/components/user/cold-plunge/coldPlungeProduct';
import Navbar from '@/components/user/Navbar';
import { allColdPlungeProducts } from '@/constants/coldPlungeProducts';
                ...
                if (data.data && data.data.length > 0) {
                    ...
                    if (dbProduct) {
                        setProduct({
                            ...
                            benefits: dbProduct.benefits || dbProduct.card_features || [],
                        });
                        setLoading(false);
                        return;
                    }
                }
                const staticProduct = allColdPlungeProducts.find(p => p.name === productName);
                if (staticProduct) {
