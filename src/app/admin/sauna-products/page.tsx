...
import AddSaunaProductModal from '@/components/admin/e-commerce/saunas/AddSaunaProductModal';
import SaunaProductsList from '@/components/admin/e-commerce/saunas/SaunaProductsList';
...
export default function SaunaProductsPage() {
    ...
    return (<div className={`min-h-screen ${darkMode ? 'bg-[#121212] text-white' : 'bg-gray-50 text-gray-900'}`}>
      ...
      <main className="container mx-auto px-4 py-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          <h1 className="text-4xl font-bold mb-2"> Sauna Products Management</h1>
          <p className={`text-lg ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            Manage all sauna products in your inventory
          </p>
        </motion.div>

        <SaunaProductsList darkMode={darkMode} refreshTrigger={refreshTrigger} onAddProduct={handleAddProduct} onEditProduct={handleEditProduct} onDeleteProduct={handleProductDeleted} onViewDetails={handleViewDetails}/>
      </main>

      <AddSaunaProductModal showModal={showAddModal} setShowModal={setShowAddModal} onProductAdded={handleProductAdded} onProductUpdated={handleProductUpdated} editProduct={editProduct} darkMode={darkMode}/>
