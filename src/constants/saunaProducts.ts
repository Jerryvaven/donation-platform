...
export const productFeatureIcons = [
    {
        ...
        description: "Effortless Assembly",
    ...
    },
    {
        ...
        description: "Ships from the US in 3-5 Business Days",
